...
namespace Key_Castle.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!await _roleManager.RoleExistsAsync(WC.AdminRole))
            {
                ...
                await _roleManager.CreateAsync(new IdentityRole(WC.BuyerRole));
                await _roleManager.CreateAsync(new IdentityRole(WC.SellerRole));
            }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, WC.BuyerRole);
                        //await _userManager.AddToRoleAsync(user, WC.SellerRole);
                    }
